...
```
1. InstaaSnap is a Open Source IG Post Downloader API, WebApp, iOS and Andoid app.
...
3. InstaaSnap is built with Node.js, Express.js, React.js, Next.js and React Native. 
```
