				...
				<ScrollView>
					...
					<View style={styles.tosContainer}>
						<Text style={styles.tosPara}>
							Welcome to our InstaaSnap. If you continue to browse and use this app, you are agreeing to comply with and be
				...
				<View style={styles.viewTwo}>
					<TouchableOpacity onPress={fetchMedia} style={styles.viewTwoBtn}>
						<Text style={styles.viewTwoBtnText}>
							Download <ActivityIndicator style={styles.viewTwoBtnIndicator} size='small' color='black' animating={indicator} />
						</Text>
					</TouchableOpacity>
				</View>
