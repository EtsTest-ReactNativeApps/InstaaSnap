        ...
        <ScrollView>
          ...
          <View style={styles.tosContainer}>
            <Text style={styles.tosPara}>
              Welcome to our InstaaSnap. If you continue to browse and use this
              app, you are agreeing to comply with and be bound by the following
              terms and conditions :
            </Text>
            <Text style={styles.tosPara}>
              We have no mechanism to check any copyright or other IP rights, on
              downloading file and content over the internet. It's the user's
              responsibility to check if the content you want to download is
              protected under any copyrights and make sure that you're allowed
              to download, copy and share the content.
            </Text>
            <Text style={styles.tosPara}>
              You're allowed to download, copy and share the content if saving
              and sharing comes under fair usage and other exceptions to
              copyright as defined by Instagram's fair usage and exceptions to
              copyright policy.
            </Text>
            <Text style={styles.tosPara}>
              You're allowed to download, copy and share the content if the
              copyright owner has clearly stated that you may freely use the
              image without obtaining permission.
            </Text>
            <Text style={styles.tosPara}>
              InstaaSnap does not backup/archive user content for any reason and
              doesn’t collect any of the user's information which makes using
              InstaaSnap totally anonymous.
            </Text>
      ...
      <View style={styles.mainView}>
        ...
        <View style={styles.viewTwo}>
          <TouchableOpacity onPress={fetchMedia} style={styles.viewTwoBtn}>
            <Text style={styles.viewTwoBtnText}>
              Download{' '}
              <ActivityIndicator
                style={styles.viewTwoBtnIndicator}
                size="small"
                color="black"
                animating={indicator}
              />
        ...
        <Text style={styles.viewTwoTitle}>
          Save Public Instagram Post And Reels
        </Text>
      </View>
    );
  }
